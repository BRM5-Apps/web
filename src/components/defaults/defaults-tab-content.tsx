...
import { useDefaultMessages, useUpdateDefaultMessage } from "@/hooks/use-default-messages";
...
import { CATEGORY_LABELS, type DefaultMessage, type MessageCategory } from "@/types/default-message";
import {
  MessageSquare,
  FileText,
  Code,
...
export function DefaultsTabContent({ serverId, showHeading = false }: DefaultsTabContentProps) {
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <CardDescription className="text-xs">
                                  {message.description || `Default ${message.key.replace(/_/g, " ")} message`}
                                </CardDescription>
                              </div>
                            </div>
